...
fn draw_leopard_separator(
    ...
    add_stop(&trench, 0.00, theme.shelf_bottom.mix(Color::rgba(0.0, 0.0, 0.0, 1.0), 0.22).with_alpha(0.03));
    add_stop(&trench, 0.70, theme.shelf_bottom.mix(Color::rgba(0.0, 0.0, 0.0, 1.0), 0.46).with_alpha(0.11));
    add_stop(&trench, 1.00, theme.shelf_bottom.mix(Color::rgba(0.0, 0.0, 0.0, 1.0), 0.30).with_alpha(0.08));
    ...
    add_stop(&shadow, 0.00, theme.shelf_bottom.mix(Color::rgba(0.02, 0.03, 0.05, 1.0), 0.48).with_alpha(0.10));
    add_stop(&shadow, 1.00, theme.shelf_bottom.mix(Color::rgba(0.02, 0.03, 0.05, 1.0), 0.50).with_alpha(0.12));
    ...
    add_stop(&highlight, 0.00, theme.shelf_highlight.with_alpha(0.05 * theme.highlight_strength));
    add_stop(&highlight, 1.00, theme.shelf_highlight.with_alpha(0.10 * theme.highlight_strength));
