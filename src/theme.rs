...
impl Default for Theme {
    fn default() -> Self {
        Self {
            ...
            shelf_top: Color::rgba(0.352_941, 0.513_725, 0.666_667, 1.0),
            shelf_bottom: Color::rgba(1.0, 1.0, 1.0, 1.0),
            shelf_stroke: Color::rgba(0.713_725, 0.733_333, 0.752_941, 1.0),
            shelf_highlight: Color::rgba(1.0, 1.0, 1.0, 1.0),
